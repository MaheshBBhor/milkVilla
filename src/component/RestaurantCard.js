const RestaurantCard = ({ restaurantList }) => {
  return (
    <div className="w-40 p-1 m-1 shadow-2xl bg-pink-50 hover:bg-pink-300 justify-center sm:w-48 md:w-56">
      <img src={restaurantList.image} alt={`${restaurantList.title} image`} className="h-24 w-full object-contain md:h-32" />
